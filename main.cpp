...
*/
class XsiliumClient : public Application
{
public:
    int framecount_;
    float time_;
    ...
    */
    XsiliumClient(Context * context) : Application(context),framecount_(0),time_(0)
    {
    }
    ...
    */
    virtual void Start()
    {
        ...
        SubscribeToEvent(button,E_RELEASED,URHO3D_HANDLER(XsiliumClient,HandleClosePressed));
        ...
        // details.
        SubscribeToEvent(E_BEGINFRAME,URHO3D_HANDLER(XsiliumClient,HandleBeginFrame));
        SubscribeToEvent(E_KEYDOWN,URHO3D_HANDLER(XsiliumClient,HandleKeyDown));
        SubscribeToEvent(E_UPDATE,URHO3D_HANDLER(XsiliumClient,HandleUpdate));
        SubscribeToEvent(E_POSTUPDATE,URHO3D_HANDLER(XsiliumClient,HandlePostUpdate));
        SubscribeToEvent(E_RENDERUPDATE,URHO3D_HANDLER(XsiliumClient,HandleRenderUpdate));
        SubscribeToEvent(E_POSTRENDERUPDATE,URHO3D_HANDLER(XsiliumClient,HandlePostRenderUpdate));
        SubscribeToEvent(E_ENDFRAME,URHO3D_HANDLER(XsiliumClient,HandleEndFrame));
    }
...
* > }
*/
URHO3D_DEFINE_APPLICATION_MAIN(XsiliumClient)
